...
## Function
This program takes user specifications and runs dice roll trials to achieve an average damage a number of armor classes. It rolls 6 sets of dice, 2 with advantage, 2 with disadvantage, and one standard. Each of these sets has one rolled as a gamble and one rolled normally.
